...
import 'package:shared_vaccination/util/url_helper.dart';
...
class RewardCard extends StatelessWidget {
  ...
  RewardCard({required this.model, required this.color, required this.borderColor, required this.index});

  RewardCard.red({required this.model, required this.index})
      : this.color = Color(0xFFB22234), //Color(0xFFFFB1BC),
        this.borderColor = Colors.white;
  //this.borderColor = Color(0xFFC62828);

  RewardCard.green({required this.model, required this.index})
    ...
    return Column(
      ...
      children: [
        InkWell(
            ...
            onTap: () async {
              await UrlHelper.launchURL(this.model.link);
            }),
      ],
    );
  }
